...
| **Brand slot** | `.brand-ph` | 8 · 0 | **held open** | **Settled 2026-08-02: the slot stays empty for now.** There is no wordmark or logotype in the repo — `assets/` holds drones, people and scenes and nothing brand — and the designer is not supplying one yet. So it is reserved, not blocked: the 44 × 24 space is held in the top bar and the screens around it can be painted without it. Nothing downstream waits on this. |
...
| 2026-08-02 | **The brand slot stays empty for now.** No wordmark exists and none is being supplied; the 44 × 24 space is held in the top bar so the screens around it can be painted without waiting. | `ui/inventory.md` |
