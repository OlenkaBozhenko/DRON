...
(function () {
  ...
  var CSS = ''
    ...
    + '  background:#FFFFFF; border-right:1px solid rgba(0,0,0,0.12); padding:56px 10px 24px;'
    ...
    + '.wf-tree a.wf-back{ position:fixed; top:0; left:0; z-index:51; box-sizing:border-box; width:248px; height:44px;'
    + '  display:flex; align-items:center; text-decoration:none; padding:0 14px;'
    + '  border-bottom:1px solid rgba(255,255,255,0.14); background:#111111; color:#FFFFFF;'
