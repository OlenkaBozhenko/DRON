...
| 4 | `people/person-operator-andriy.png` | Andriy M. face forward — the same operator `tracking` already shows from behind. Needed because a round avatar cannot crop a back-of-head | `order-confirmed`, **`call`** (added 2026-08-16) | §5.2 operator, same pose |
