...
| notifications | New | New | Heading | new 2026-08-31 — the unread group. One word, and it is the **whole** unread signal on this screen, which is why it is a heading and not a dot: it also sorts |
| notifications | Earlier | Earlier | Heading | new 2026-08-31 — the read group. Not *Read*, which describes the system's bookkeeping; *Earlier* describes when it happened, which is what the reader is actually scanning for |
| notifications | New | Your delivery photo is ready | Row title | new 2026-08-31 — `CE-4`. **P1**, the outcome not the equipment; **O5**, *delivery photo* is the deliverable's one name, never *result* |
| notifications | New | Package delivery · Today, 10:12 | Row meta | new 2026-08-31 — which order, then when. **P2**: the proof line, not decoration, which is why rev 209's optional `__desc` is spent here |
| notifications | New | Ivan is 2 minutes away | Row title | new 2026-08-31 — `CE-4`'s own push, the *"Operator is 2 min away"* the sitemap has quoted since the first cut, said with the name the client has already been shown. **Operator**, never *pilot*; here his name, because by this point he is not a category |
| notifications | New | Ivan K. accepted your order | Row title | new 2026-08-31 — `RJ-C1` / `RJ-C2`, the moment the void closes. **Order**, the client's word, never *job* |
| notifications | Earlier | Rate your order | Row title | new 2026-08-31 — the one row that asks for something. Plain imperative, no *Please*, no exclamation |
| notifications | Earlier | Your photo and video set is ready | Row title | new 2026-08-31 — **O5**, the aerial deliverable's own name, matching `delivery-aerial`'s zone |
| notifications | Earlier | Your inspection report is ready | Row title | new 2026-08-31 — **O5**, the inspection deliverable's own name |
...
| operator-notifications | New | ₴720 paid to your balance | Row title | new 2026-08-31 — `RJ-O3`. **paid**, the vocabulary's word for earnings landing, never *transferred* or *credited*; the amount leads because on this side the amount is the news |
| operator-notifications | New | New job offer · Package delivery | Row title | new 2026-08-31 — `OE-6`, the dispatch alert. **job**, never *order*: this is the operator's side of the wall. It is in the log although it is **not** in the settings card, and that is the point — `sitemap.md` bars silencing dispatch, so an offer that expired in a pocket must at least be findable |
| operator-notifications | New | Podil → Osokorky · Today, 10:45 | Row meta | new 2026-08-31 — the route, then the time. The offer's own two facts, in the order `job-offer` states them |
| operator-notifications | New | Your documents are approved | Row title | new 2026-08-31 — `MJ-2`'s gate clearing. Plain and factual; `operator-verification-loading` already promises *We'll notify you when it's approved*, and this is that promise kept, in the same words' register |
| operator-notifications | Earlier | Olena H. rated your job 5 stars | Row title | new 2026-08-31 — `EJ-3`. The client is named, which is what makes it standing rather than a statistic; **job**, not *order* |
| operator-notifications | Earlier | Withdrawal sent to your card | Row title | new 2026-08-31 — **Withdrawal**, the vocabulary's word for money going out, held apart from *paid* one group above. Two money events, two words, never crossed |
